...
// 流星
class ShootingStar {
    constructor(init=new Crood, final= new Crood, size= 150, speed= 250, onDistory= null){
        this.init = init;   // 初始位置
...
class MeteorShower {
    ...
    createStar() {
        ...
        let star = new ShootingStar(init,final,size,speed,()=>{this.remove(star)})
    ...
    tick() {
        ...
        let _tick = ()=>{
            ...
            ctx.fillStyle = 'rgba(0,0,0,0.8)';// 每一帧用“半透明”的背景色清楚画布
